  ...
  <div className={styles.toggle}>
    <label>
      <input
        type="radio"
        name="imageSource"
        checked={!form.useFile}
        onChange={() => setForm(prev => ({ ...prev, useFile: false }))}
      />
      Ссылка
    </label>
    <label>
      <input
        ...
        name="imageSource"
        checked={form.useFile}
        onChange={() => setForm(prev => ({ ...prev, useFile: true }))}
      />
      Файл
    </label>
  </div>
    ...
    />
        ...
        <label className={styles.field}>
          ...
          <select name="organization" value={form.organization} onChange={handleChange}>
            <option value="">Выберите</option>
            <option>ГАПОУ СО «Саратовский архитектурно-строительный колледж» </option>
            <option>ГАПОУ СО «Саратовский колледж кулинарного искусства» </option>
            <option>ГАПОУ СО «Саратовский областной химико-технологический техникум»  </option>
            <option>ГАПОУ СО «Саратовский областной педагогический колледж»  </option>
            <option>ГАПОУ СО «Саратовский колледж промышленных технологий и автомобильного сервиса»  </option>
            <option>ГАПОУ СО «Саратовский колледж строительства мостов и гидротехнических сооружений»</option>
            <option>ГАПОУ СО «Саратовский политехнический колледж» </option> 
            <option>ГАПОУ СО "Саратовский колледж водного транспорта, строительства и сервиса"  </option>
            <option>ГАПОУ СО «Саратовский техникум отраслевых технологий»  </option>
            <option>ГАПОУ СО «Энгельсский механико-технологический колледж»  </option>
            <option>ГАПОУ СО «Энгельсский политехникум» </option>
            <option>ГАПОУ СО «Энгельсский колледж профессиональных технологий»  </option>
            <option>ГАПОУ СО «Энгельсский промышленно-экономический колледж»</option>
            <option>ГАПОУ СО «Балашовский техникум механизации сельского хозяйства»  </option>
            ...
            <option>ГБПОУ СО «Краснопартизанский политехнический лицей» </option>
            <option>ГАПОУ СО «Пугачевский аграрно-технологический техникум»  </option>
            <option>ГАПОУ СО «Петровский аграрно-технологический техникум»  </option>
            ...
            <option>ГБПОУ СО «Александрово-Гайский политехнический лицей»  </option>
            <option>ГБПОУ СО «Ивантеевский техникум агропромышленных технологий и управления» </option>
            ...
            <option>ГАПОУ СО «Сельскохозяйственный техникум им.К.А.Тимирязева»  </option>
            <option>ГАПОУ СО «Новоузенский агротехнологический техникум»  </option>
            <option>ГАПОУ СО «Балаковский политехнический техникум»  </option>
            <option>ГАПОУ СО «Перелюбский аграрный техникум»  </option>
            <option>ГАПОУ СО «Базарнокарабулакский техникум агробизнеса»  </option>
            <option>ГАПОУ СО «Балаковский промышленно-транспортный техникум им.Н.В.Грибанова»  </option>
            <option>ГАПОУ СО «Марксовский политехнический колледж» </option>
            <option>ГАПОУ СО «Поволжский колледж технологий и менеджмента» (г.Балаково)  </option>
            <option>ГАПОУ СО «Вольский педагогический колледж им. Ф.И. Панферова»  </option>
          </select>
        </label>
