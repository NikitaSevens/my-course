                    ...
                    <>
                      <label>
                        ...
                        <input
                          ...
                          required
                          pattern="^([А-ЯЁ][а-яё]+(?:-[А-ЯЁа-яё]+)?\s){2}[А-ЯЁ][а-яё]+(?:-[А-ЯЁа-яё]+)?$"
                          title="Введите ровно три слова: Фамилию, Имя и Отчество. С заглавной буквы, только русские буквы, допускается один дефис в каждом слове."
