          ...
          <div className={styles.form}>
            <div className={styles.scrollOne}>
              ...
              <label>
                ...
                <select value={selectedCourseTitle} onChange={e => setSelectedCourseTitle(e.target.value)} required>
            ...
            <div className={styles.scrollTwo}>
              ...
              {documentType === 'birthCert' && (
                <>
                  ...
                  <label>Номер телефона родителя:<input value={parentPhone} onChange={e => setParentPhone(e.target.value)} /></label>
                  <label>Электронная почта родителя:<input type="email" value={parentEmail} onChange={e => setParentEmail(e.target.value)} /></label>
                  <label>
