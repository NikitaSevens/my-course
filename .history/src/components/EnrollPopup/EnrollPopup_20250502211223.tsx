            ...
            <div className={styles.scrollOne}>
              ...
              <label>
                ...
                <input
                  value={snils}
                  onChange={(e) => {
                    // Удаляем все нецифровые символы и ограничиваем длину 11 цифрами
                    const cleanedValue = e.target.value
                      .replace(/\D/g, "")
                      .slice(0, 11);
                    setSnils(cleanedValue);
                  }}
                  maxLength={11} // Это обеспечит визуальное ограничение в браузере
                  type="text" // Используем text, чтобы иметь больше контроля над вводом
