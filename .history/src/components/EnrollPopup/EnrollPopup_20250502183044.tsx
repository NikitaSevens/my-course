    ...
    <div className={styles.overlay}>
      <div className={styles.popup}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          <div className=className={styles.crollTwo}>
            ...
            {documentType === 'passport' && (
              <>
                ...
                <label>Адрес по паспорту:<input value={passportAddress} onChange={e => setPassportAddress(e.target.value)} /></label>
                <label>
                  <input type="checkbox" checked={notLivingByPassport} onChange={e => setNotLivingByPassport(e.target.checked)} />
                  Проживаю не по паспорту
                </label>
                {notLivingByPassport && (
                  <label>Фактический адрес:<input value={customAddress} onChange={e => setCustomAddress(e.target.value)} /></label>
                )}
              </>
            )}
          ...
          <div className={styles.crollTwo}>
            ...
            <label>Возраст:<input type="number" min="5" value={age} onChange={e => setAge(e.target.value)} required /></label>
