          ...
          <div className={styles.cloudBackground}>
            <div className={styles.heroContent}>
              ...
              <div className={styles.floatingTags}>
                ...
                <span style={{ top: "-10px", left: "12%",  fontSize: "1.3vw", }}>#UI/UX</span>
                <span style={{ top: "70px", left: "23%",  fontSize: "1.3vw", } }>#Frontend</span>
                <span style={{ top: "-100px", right: "6%",  fontSize: "1.3vw", }}>#группы</span>
                <span style={{ top: "-60px", right: "15%",  fontSize: "1.3vw", }}>#образование</span>
                <span style={{ top: "3px", right: "4%",  fontSize: "1.3vw", }}>#обучение</span>
              </div>
            </div>
          </div>
        </section>
