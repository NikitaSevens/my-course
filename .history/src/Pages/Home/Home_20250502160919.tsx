...
const Home = () => {
    ...
    <>
      <main className={styles.main}>
        ...
        <section id="hero" className={styles.hero}>
          ...
          <Header />
              <img className={styles.heroImg} src="src/assets/copp.svg" alt="" />
              ...
              <div className={styles.floatingTags}>
                ...
                <span style={{ top: "-120px", right: "6%",  fontSize: "1.3vw", }}>#группы</span>
  ...
  <div className={styles.reasonItem}>
    <h2><strong>Why choose</strong> Artistry?</h2>
    <p>
      Our students are chosen to study in our children's school because of the
      high quality of education
    </p>
  </div>
  <div className={styles.reasonItem}>
    <img src="src/assets/reason1.svg" alt="Full Development" />
  ...
  <div className={styles.reasonItem}>
    <img src="src/assets/reason2.svg" alt="Love Children" />
    <h3>Love Children</h3>
    <p>
