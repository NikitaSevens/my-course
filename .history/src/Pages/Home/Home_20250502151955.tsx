...
const Home = () => {
  ...
  <div className={styles.tags}>
    <span className={styles.float1}>#рисование</span>
    <span className={styles.float2}>#UI/UX</span>
    <span className={styles.float3}>#Frontend</span>
    <span className={styles.float4}>#группы</span>
    <span className={styles.float5}>#образование</span>
    <span className={styles.float6}>#обучение</span>
  </div>
</div>
